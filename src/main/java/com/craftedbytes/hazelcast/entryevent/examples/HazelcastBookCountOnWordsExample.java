package com.craftedbytes.hazelcast.entryevent.examples;
...
/**
 * Bootstraps a Hazelcast Cluster Member via Spring Context.  Then puts in texts of 3 books into a map.  Each put
 ...
 * <P>
 * Note: In the Spring Context that the wiring of the EntryEventProcessors into the EntryEventService is carried
